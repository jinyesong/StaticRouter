...
public class IPLayer implements BaseLayer {
   ...
   public boolean Receive(byte[] input) { // 패킷 수신
      ...
      if (flag[0] == 1 & flag[1] == 0 & flag[2] == 1) { // UH
        System.out.println("난 IPLayer UH.");
         ...
         if (hasIp == -1) {
            System.out.println("난 IPLayer UH인데 ARP 요청");
            ((ARPLayer) this.GetUnderLayer()).ARPSend(src_ip, dst_ip);
         } else {
           System.out.println("난 IPLayer UH인데  바로 송신");
   ...
   public boolean Send() { // 패킷송신
      ...
      System.out.println("난 IPLayer의 Send. 패킷을 보내지.");
      return true;
   }
